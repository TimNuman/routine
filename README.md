...
- **Ritme** — de stappen van vandaag als kaartjes, per groep. Bovenin schakel je
  ...
  telefoon. Tik op de stap zelf en het kaartje komt omhoog uit het raster — zijn
  plek blijft zolang leeg — en staat groot over de volle breedte van het scherm,
  met het plaatje, de naam en de gezichtjes. Vegen wisselt van stap: deze zakt
  terug op zijn eigen plek terwijl de volgende van de zijne omhoog komt. Naast de
  kaart tikken, of hem omlaag vegen, legt hem terug.
  Daarboven staat per kind hoever het is. Elke dag begint vanzelf leeg.
...
meteen mee, in twee stappen. Eerst *wie wonen er in huis*: hoeveel kinderen, en
per kind een naam, een gezicht en een verjaardag. Dat is sneller ingevuld dan
uitgeschreven. Daarna *hoe ziet de week eruit*, in gewone woorden: school, bso,
sport, clubjes. Dat gaat naar de uitlezer, die de kinderen dan al kent — en dat
scheelt: hij hoeft niemand meer te verzinnen en kan alles meteen bij de goede
naam zetten.

Wat eruit komt zijn voorstellen met vinkjes, in stukken: *Kinderen*, *In het
ritme*, *Elke week*, *Eenmalig*. Pas als je op de knop drukt staat het in de
app. Beschrijf je in één alinea je hele gezin (dat mag ook), dan worden de
kinderen als eerste aangemaakt, zodat de weekregels en de stappen naar de goede
naam kunnen wijzen.
